        ...
        <tr style="padding:0;text-align:center;vertical-align:top;width:100%;" align="center">
            <td>                 
                ...
                <div style="float: left;width: 60%;">
                    <span style="padding:0 25px;color:#4a5773;font:400 16px Arial;margin-bottom:30px;text-align:left;float:left;width:100%;"><?= Yii::t('app', 'Для подтверждения email перейдите по ссылке') ?></span>
                    <a href="<?= $activationLink ?>" style="float: left;width:164px;height:40px;text-align:center;background-color:#1c69ff;color:#ffffff;font:400 16px Arial;text-transform:uppercase;text-decoration:none;line-height:40px;margin-bottom:30px;margin-right:15px;margin-left:25px;"><?= Yii::t('app', 'Перейти') ?></a>
                </div>
